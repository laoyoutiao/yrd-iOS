...
#define kBackAppURL @"rechargeOver"

//@interface QMWebViewController ()<UIWebViewDelegate>

//@end

@implementation QMWebViewController2
{
...
+ (void)showWebViewWithRequest:(NSURLRequest *)request
    ...
    QMWebViewController2 *con = [[QMWebViewController2 alloc] init];
    con.isModel = isModel;
    con.navTitle = title;
    con.request = request;
