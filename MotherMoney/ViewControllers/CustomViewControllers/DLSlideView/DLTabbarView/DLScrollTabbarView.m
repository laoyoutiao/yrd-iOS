...
- (void)commonInit{
    ...
    trackView_ = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-kTrackViewHeight-1, self.bounds.size.width/2, kTrackViewHeight)];
    ...
    separatorLine.backgroundColor = QM_COMMON_BACKGROUND_COLOR;
