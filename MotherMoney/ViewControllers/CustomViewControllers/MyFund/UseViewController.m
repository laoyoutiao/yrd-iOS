...
#define USE_CELL_IDENTIFIER @"use_cell_identifier"
@interface UseViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [[NetServiceManager sharedInstance] getMyUseCouponListWithdelegate:self success:^(id responseObject) {
        NSArray *list = [responseObject objectForKey:@"list"];
        
        for (NSDictionary *dic in list) {
            QMUseCouponModel *model = [[QMUseCouponModel alloc] initWithDictionary:dic];
...
- (void)customScrollView{
    ...
    [packetListTable registerClass:[UserCollectionViewCell class] forCellWithReuseIdentifier:USE_CELL_IDENTIFIER];
...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    UserCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:USE_CELL_IDENTIFIER forIndexPath:indexPath];
