//
//  QMPrizePacketCollectionViewCell.m
//  MotherMoney
//
...
@implementation QMPrizePacketCollectionViewCell{
...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        moneyIcon=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"packet_icon2"]];
        ...
        currentScoreTitleLabel.text=@"我的红包";
...
- (void)setUserTicketCount:(NSString *)userTicketCount{
    currentScoreValueLabel.text = [NSString stringWithFormat:@"%@",userTicketCount];
}
@end
