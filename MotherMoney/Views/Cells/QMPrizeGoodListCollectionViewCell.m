//
//  QMPrizeGoodListCollectionViewCell.m
//  MotherMoney
//
...
@implementation QMPrizeGoodListCollectionViewCell{
...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        moneyIcon=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"packet_icon1"]];
        ...
        currentScoreTitleLabel.text=@"我的金币";
...
- (void)setScoreValue:(NSString *)scoreValue{
    currentScoreValueLabel.text = [NSString stringWithFormat:@"%@",scoreValue];
}
@end
