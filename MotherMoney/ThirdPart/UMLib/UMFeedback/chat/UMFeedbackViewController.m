...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGSize labelSize = [content boundingRectWithSize:CGSizeMake(226.0f, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:14.0f], NSFontAttributeName, nil] context:nil].size;
...
- (NSString *)title {
    return QMLocalizedString(@"qm_more_feedback_title", @"在线客服");
}
